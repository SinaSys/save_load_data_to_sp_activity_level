...
public class MainActivity extends AppCompatActivity {
	...
	public void saveAccountData(View view) { // Save data to Activity Level SharedPrefs
	...
	public void loadAccountData(View view) { // Load data from Activity Level SharedPrefs
